...
def create_pre_embeding(stim, PRE_COMPUTED_EMBEDDINGS):
    df_fixation=pd.read_csv('../cross_valid_result_number/cross_valid_result_300/'+stim+'_'+stim[4:]+"_aug"+parse.aug+".csv",nrows=int(parse.number))
...
np.save(f"../processed_data/PRE_COMPUTED_EMBEDDINGS_STIM_LINE_11_{parse.aug}.npy", PRE_COMPUTED_EMBEDDINGS)
